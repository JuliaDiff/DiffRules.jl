...
@define_diffrule Base.cosd(x)                 = :( -(oftype($x, π) / 180) * sind($x)               )
@define_diffrule Base.tand(x)                 = :(  (oftype($x, π) / 180) * (1 + tand($x)^2)       )
@define_diffrule Base.secd(x)                 = :(  (oftype($x, π) / 180) * secd($x) * tand($x)    )
@define_diffrule Base.cscd(x)                 = :( -(oftype($x, π) / 180) * cscd($x) * cotd($x)    )
@define_diffrule Base.cotd(x)                 = :( -(oftype($x, π) / 180) * (1 + cotd($x)^2)       )
@define_diffrule Base.sinpi(x)                = :(  oftype($x, π) * cospi($x)                      )
@define_diffrule Base.cospi(x)                = :( -oftype($x, π) * sinpi($x)                      )
...
@define_diffrule Base.asind(x)                = :(  180 / oftype($x, π) / sqrt(1 - $x^2)           )
@define_diffrule Base.acosd(x)                = :( -180 / oftype($x, π) / sqrt(1 - $x^2)           )
@define_diffrule Base.atand(x)                = :(  180 / oftype($x, π) / (1 + $x^2)               )
@define_diffrule Base.asecd(x)                = :(  180 / oftype($x, π) / abs($x) / sqrt($x^2 - 1) )
@define_diffrule Base.acscd(x)                = :( -180 / oftype($x, π) / abs($x) / sqrt($x^2 - 1) )
@define_diffrule Base.acotd(x)                = :( -180 / oftype($x, π) / (1 + $x^2)               )
